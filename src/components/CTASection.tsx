    ...
    <section className="px-6 py-24 text-center bg-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        <div className="flex justify-center items-center gap-3 mb-8">
          <div className="h-px w-12 bg-red-100" />
        ...
        <p className="text-lg text-gray-400 font-medium mb-12 max-w-md mx-auto leading-relaxed">
          Romance is a moment. Make yours count with a message that feels like you.
        </p>

        <Link href="/create" className="group relative bg-gray-900 text-white px-10 py-5 rounded-2xl text-lg font-bold transition-all duration-300 hover:bg-red-500 hover:scale-105 active:scale-95 shadow-xl shadow-gray-200 hover:shadow-red-200 items-center gap-3 mx-auto inline-flex">
          Create Your Message
